...
def validate_data(age, investment_amount, intent_request):
    ...
    # Validate the investment amount, it should be equal or greater than 5000
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment is $5,000 USD, could you please provide a greater amount?",
            )
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """{first_name} thank you for your information;
...
def lambda_handler(event, context):
    ...
    return dispatch(event)
>>>>>>> 9864495d45f3dca119d76e2b3ea853ed5737b9ea
